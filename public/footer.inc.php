  ...
  <footer class="mt-24 bg-gray-900 sm:mt-12">
    <div class="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
      <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
        <div class="px-5 py-2">
          <a href="/login" class="text-base text-gray-400 hover:text-gray-300">
            Login
          </a>
        </div>
      </nav>
      <div class="mt-8 flex justify-center space-x-6">
        <a href="https://github.com/loginwith" class="text-gray-400 hover:text-gray-300">
...
?>
  ...
  <script defer data-domain="loginwith.xyz" src="https://plausible.io/js/plausible.js"></script>
</body>
</html>
