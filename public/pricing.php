...
<div class="bg-white">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6">
        <div class="flex justify-between items-center border-b border-indigo-400 border-opacity-25 py-6 md:justify-start md:space-x-10">
          ...
          <div class="-mr-2 -my-2 md:hidden">
            <button type="button" class="bg-indigo-900 rounded-md p-2 inline-flex items-center justify-center text-indigo-300 hover:text-white hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-white" aria-expanded="false">
          ...
          <nav class="hidden md:flex space-x-10">
            <div class="relative">
              ...
              <button type="button" class="text-indigo-300 group bg-indigo-900 rounded-md inline-flex items-center text-base font-medium hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-indigo-900 focus:ring-white" aria-expanded="false">
                <span>Guides</span>
                <!--
                  ...
                  Item active: "text-white", Item inactive: "text-indigo-300"
                -->
                <svg class="text-indigo-300 ml-2 h-5 w-5 group-hover:text-white" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
              ...
              -->
              <div class="hidden absolute z-10 -ml-4 mt-3 transform w-screen max-w-md px-2 sm:px-0 lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
            ...
            <a href="/pricing" class="text-base font-medium text-indigo-300 hover:text-white">
              Pricing
            </a>
            <a href="/docs" class="text-base font-medium text-indigo-300 hover:text-white">
              Docs
            </a>
        ...
        <div class="rounded-lg shadow-lg bg-white ring-1 ring-black ring-opacity-5 divide-y-2 divide-gray-50">
          ...
          <div class="py-6 px-5 space-y-6">
            <div class="grid grid-cols-2 gap-y-4 gap-x-8">
              ...
              <a href="/docs" class="text-base font-medium text-gray-900 hover:text-gray-700">
                Docs
              </a>
  ...
  <footer class="mt-12 max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
    ...
    <div class="xl:grid xl:grid-cols-3 xl:gap-8">
      ...
      <div class="hidden mt-8 xl:mt-0"><!-- newsletter -->
        <h4 class="text-sm font-semibold text-gray-400 tracking-wider uppercase">
    ...
    <div class="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
      ...
      <p class="mt-8 text-base text-gray-400 md:mt-0 md:order-1">
        &copy; 2022 LoginWith.xyz. All rights reserved.
      </p>
    </div>
  </footer>
</div>
