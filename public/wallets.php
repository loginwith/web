...
<div class="bg-white">
  <header class="relative pb-24 bg-sky-800 sm:pb-32">
    ...
    <div class="relative mt-24 max-w-md mx-auto px-4 sm:max-w-3xl sm:mt-32 sm:px-6 lg:max-w-7xl lg:px-8">
      <h1 class="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">Wallet Support</h1>
...
<main class="mt-16 mx-auto max-w-7xl px-4 sm:mt-24 sm:px-6 lg:mt-32">
  ...
  <p>
  LoginWith supports dozens of different wallets. Whether you're using one built into your browser, an extension, or a hardware wallet, you're covered. As website operator, choose what networks (e.g., Bitcoin, Ethereum, Solana, etc.) you want to allow users to sign in from.
  </p>
